...
export default function App() {
  ...
  const suggestedQuestions = [
    ...
    "How does the Future Soldier Preparatory Course work?",
    "What are the requirements for OCS (09S) enlistment?",
  ];
    ...
    <div style={styles.container}>
      ...
      <div style={styles.sidebar}>
        ...
        <div style={styles.sidebarInfo}>
          ...
          <div style={styles.infoValue}>20 documents &bull; 50 sections</div>
        ...
        <div style={styles.sidebarInfo}>
          ...
          <div style={styles.infoDetail}>
            ...
            programs &bull; MEPS processing &bull; Incentives &bull;
            Live Scan &bull; Security clearance &bull; Future Soldier Prep
          </div>
        </div>
        <div style={styles.disclaimer}>
          â  Always verify with your chain of command. This tool is for reference
          only.
        </div>
      </div>
        ...
        <div style={styles.chatArea}>
          {messages.length === 0 ? (
            <div style={styles.welcome}>
              <div style={styles.welcomeIcon}>ðï¸</div>
              ...
              <p style={styles.welcomeText}>
                ...
                incentives, or MEPS processing. I reference the complete text of
                all 20 official ARNG regulatory documents including AR 601-210,
                FY26 AOC, WASP, and all current SMOMs.
              </p>
                ...
                >
                  ...
                  {msg.sources && msg.sources.length > 0 && (
                    <div style={styles.sourcesArea}>
                      <span style={styles.sourcesLabel}>ð Sources:</span>
                      {msg.sources.map((s, j) => (
